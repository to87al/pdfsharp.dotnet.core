...
//        if (mapping.HasClusterCount
      ...
      while (!stop);
        ...
        static void AddCapToPath(Path path, PathFigure figure, double length, double lineWidthHalf, PenLineCap lineCap, XMatrix matrix)
        {
            // sketch:
      ...
      WriteSegment(lseg);
        ...
        {
            XPoint posSave = pos;
            pos -= new XVector(this.graphicsState.realizedTextPosition.X, this.graphicsState.realizedTextPosition.Y);
